...
namespace System.IO.FilterBuilder
{
    ...
    public class FilterGroup
    {
        ...
        /// </returns>
        private bool Contains(GrammarEdit.Core.FilterBuilder.Filters filter) => sFilters.Contains(Helpers.ReturnFilterAsString(filter));
        ...
        public void Add(GrammarEdit.Core.FilterBuilder.Filters filter)
        {
        ...
        public void Add(GrammarEdit.Core.FilterBuilder.Filters[] filters)
        {
            //Add filter to the list
            foreach (GrammarEdit.Core.FilterBuilder.Filters item in filters)
            {
        ...
        public void Add(string extension, bool plural = true)
        {
            ...
            try
            {
                description = new GrammarEdit.Core.FilterBuilder().GetSystemFileTypeDescription(extension);
            }
            catch (Exception)
            {
                description = "";
